...
<div class="container">  
      ...
      <div class="row">
         <div class="col-md-6 mt-3">
           <img class="featurette-image img-responsive center-block" src="<%=cereal.getFile()%>" data-src="holder.js/500x500/auto" alt="Generic placeholder image" style="width:350px; height:400px; position:absolute; top:50; left:20;">
        </div>
        <div class="col-md-6">
        <div class="row">
          <h1 style="color:white;font-family: 'Comfortaa', cursive; font-size:35px; position:absolute; top:120;"><%=cereal.getName()%></h1>
          <p class="card-text" style="text-align:center; color:#D2B48C; font-family: 'Comfortaa', cursive; font-size:20px; position:absolute; top:200;">Price: <%=cereal.getPrice()%>$</p>
          <p style="color:white;font-family: 'Comfortaa', cursive; font-size:18px; position:absolute; top:230;"><%=cereal.getNote()%></p>
