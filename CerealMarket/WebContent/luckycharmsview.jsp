...
<body style="background-color: #b5333a;">
...
<div class="container"> 
      ...
      <div class="row">
        ...
        <div class="col-md-6">
        <div class="row">
          <h1 style="color:black; font-family: 'Potta One', cursive; font-size:35px; position:absolute; top:120;"><%=cereal.getName()%></h1>
          <p class="card-text" style="text-align:center; color:#619c4e; font-family: 'Potta One', cursive; font-size:20px; position:absolute; top:200;">Price: <%=cereal.getPrice()%>$</p>
          <p style="color:white; font-family: 'Potta One', cursive; font-size:24px; position:absolute; top:240;"><%=cereal.getNote()%></p>  
